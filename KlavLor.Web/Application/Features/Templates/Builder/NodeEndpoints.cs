...
public sealed class NodeEndpoints : IEndpoint
{
    ...
    {
        app.MapGet(AppRoutes.BuilderNodeCreate.FromApi(), GetCreateModal).RequireAuthorization(nameof(RoleName.User)).RequireRateLimiting("read");
        ...
        app.MapGet(AppRoutes.BuilderNodeEdit.FromApi(), GetEditModal).RequireAuthorization(nameof(RoleName.User)).RequireRateLimiting("read");
